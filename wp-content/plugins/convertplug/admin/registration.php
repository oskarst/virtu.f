...
<div class="wrap about-wrap about-cp bend">
  <div class="wrap-container">
    <div class="bend-heading-section cp-about-header">
      <h1><?php _e( CP_PLUS_NAME . " &mdash; Registration", "smile" ); ?></h1>
      <h3><?php _e( "When you register your copy of " . CP_PLUS_NAME . ", instant access to our support portal, one click updates, extensions and many other addon freebies will be unlocked to you. It is a one time process and will take less than a minute!.", "smile" ); ?></h3>
    ...
    <div class="bend-content-wrap">
      <div class="smile-settings-wrapper">
        <h2 class="nav-tab-wrapper">
            ...
            <!-- <a class="nav-tab" href="?page=convertplus&view=cp_import" title="<?php _e( "Import", "smile" ); ?>"><?php echo __( "Import", "smile" ); ?></a> -->

            <a class="nav-tab nav-tab-active" href="?page=convertplus&view=registration" title="<?php _e( "Registration", "smile"); ?>"><?php echo __("Registration", "smile" ); ?></a>

            <a class="nav-tab" href="?page=convertplus&view=knowledge_base" title="<?php _e( "knowledge Base", "smile"); ?>"><?php echo __("Knowledge Base", "smile" ); ?></a>
      ...
      <div class="container">
        <div class="col-md-12 text-center" style="margin-bottom: 50px;">
          <?php _e( "Thank you for choosing " . CP_PLUS_NAME . ". We are thrilled and committed to make your WordPress experience better.", "smile" ); ?>
        </div>
      </div><!-- container -->
