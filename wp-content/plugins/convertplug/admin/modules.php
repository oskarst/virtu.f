  ...
  <div class="wrap-container">
    ...
    <div class="bend-content-wrap">
	    <h2 class="nav-tab-wrapper">
            ...
            <a class="nav-tab nav-tab-active" href="?page=convertplus&view=modules" title="<?php _e( "Modules", "smile" ); ?>"><?php echo __( "Modules", "smile" ); ?></a>
    ...
    <div id="smile-module-settings">
        ...
        <a class="button button-secondary button-hero advance-cp-setting" href="?page=convertplus&view=settings" title="<?php _e( "Advanced Settings", "smile" ); ?>"><?php echo __("Advanced Settings", "smile" ); ?></a>
