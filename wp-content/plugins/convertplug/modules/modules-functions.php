...
if( !function_exists('cp_notify_sub_to_admin') ) {
	function cp_notify_sub_to_admin( $list_name, $subscriber_data, $sub_email, $email_sub, $email_body) {
		$email_name = array();	
		...
		$body .= $body_content; 
		$body .= "<p>Congratulations! Wish you many more.<br>This e-mail was sent from " . CP_PLUS_NAME . " on ". get_bloginfo('name') ." (". esc_url( site_url() ) . ")</p>";
		...
		$body = isset( $email_body ) ? $content : $body ;	
