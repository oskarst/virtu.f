   ...
   function hideOnDevice(devices){
            ...
            if(!cookie && delay && display && scheduled && referred ){
                setTimeout(function() {
                    if( jQuery(".ib-display").length <= 0 ) {
                        ...
                        if( !info_bar.hasClass('cp_impression_counted') && !info_bar.hasClass( 'cp-disabled-impression' ) ) {
    ...
    function count_inline_impressions()  {
        jQuery(".cp-info_bar-inline-end").each(function(e) {
            ...
            if( is_visible ) {
                var styleArray = Array();
                if( !jQuery("[data-info_bar-style="+style_id+"]").hasClass('cp_impression_counted') && !jQuery("[data-info_bar-style="+style_id+"]").hasClass( 'cp-disabled-impression' ) ) {
