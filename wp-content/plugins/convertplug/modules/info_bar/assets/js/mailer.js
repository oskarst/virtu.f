			...
			jQuery.ajax({
				...
				success: function(result){
					...
					if( detailed_msg !== '' && detailed_msg !== null ) {
						...
						detailed_msg += "<div class='cp-admin-error-notice'>Read How to Fix This, click <a target='_blank' href='https://www.convertplug.com/plus/docs/something-went-wrong/'>here</a></div>";
