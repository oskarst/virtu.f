...
if( function_exists( "smile_update_settings" ) ) {
	...
	/* Get ConvertPlus Form Option Array */
	global $cp_form;
	global $cp_social;
	...
	$advance_options = array (
		...
		array(
			...
			"name" 		=> "position_link",
			"opts"		=> array(
				"link" 		=> __( "If your theme has fixed header feature then there might be chances of Push Page will not work. In that case find ID or class of fixed header div & enter it <a target=\"_blank\" href=\"".admin_url('admin.php?page=convertplus&view=debug&author=true')."\">here.</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"section"      => "Design",
	...
	$behavior = array(
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( "Info Bar will trigger after `".$user_inactivity."  ".__("Seconds", "smile" )."` of user inactivity. If you would like, you can change the time <a target=\"_blank\" href=\"".admin_url('admin.php?page=convertplus&view=settings#user_inactivity')."\">here</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> __( "Smart Launch", "smile" ),
