...
if( function_exists( "smile_update_settings" ) ){
	...
	$adv_design_options = array (
		...
		array(
			...
			"opts"		=> array(
				...
				"value" 		=> "Powered by " . CP_PLUS_NAME . "<sup>&trade;</sup>",
			),
			"panel" => __( "Advance Design Options", "smile" ),
			"section" => __( "Design", "smile" ),
			"section_icon" => "connects-icon-image",
	...
	$behavior = array(
		...
		array(
			...
			"opts"		=> array(
				"link" 		=> __( "Modal will trigger after `".$user_inactivity."  ".__("Seconds", "smile" )."` of user inactivity. If you would like, you can change the time <a target=\"_blank\" href=\"".admin_url('admin.php?page=convertplus&view=settings#user_inactivity')."\">here</a>", "smile" ),
				"value" 		=> "",
				"title" 		=> "",
			),
			"panel" 	=> __( "Smart Launch", "smile" ),
		...
		array(
			...
			"opts" 		=> array(
				"title" 	=> __( "Visible to Users of Type-","smile"),
				"value" 	=> "",
				"options" 	=> $user_arr,
				),
			"panel" 	=> __("Target Visitors",  "smile" ),
...
if( function_exists( "smile_update_default" ) ){
	...
	$special_offer_default = array(
		...
		"modal_overlay_bg_color" 	 => "rgba(0, 0, 0, 0.7)",
		"affiliate_title"	 	 => __( "Powered by " . CP_PLUS_NAME . "<sup>&trade;</sup>", "smile" ),
		"cp_modal_width"     	 => "750",
