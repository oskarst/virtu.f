                ...
                if( jQuery(".si-open").length <= 0 || (slidein.find(".cp-slide-in-float-on").length!== 0 )) {
                    ...
                    setTimeout(function() {                                              
                        ...
                        if( display ) {
                            ...
                            if( !slidein.hasClass('cp_impression_counted') && !slidein.hasClass( 'cp-disabled-impression' ) ) {
...
jQuery(window).on( 'slideinOpen' , function( e, slidein ) {
    ...
    if( slidein.hasClass("cp-minimize-widget") ) {
    ...
    function count_inline_impressions()  {
        jQuery(".cp-slide_in-inline-end").each(function(e) {
            ...
            if( is_visible ) {
                var styleArray = Array();
                if( !jQuery("[data-slidein-style="+style_id+"]").hasClass('cp_impression_counted') && !jQuery("[data-slidein-style="+style_id+"]").hasClass( 'cp-disabled-impression' ) ) {
