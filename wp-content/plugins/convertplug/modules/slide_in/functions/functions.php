	...
	function cp_get_slidein_image_url_init( $a = '' ) {
		if( $a['slidein_img_src'] == 'custom_url' ) {
			...
			if ( strpos($a['slidein_image'],'http') !== false ) {
				...
				$slidein_image = cp_get_protocol_settings_init($slidein_image);
			} else {
